...
\begin{itemize}
    ...
    \item GitHub as code repository
    \item Visual Studio Code as IDE
    \item pdflatex as LaTeX compiler
    \item Instagantt as project management software
\end{itemize}
...
offset from the origin, and that the coordnates
lay on the first quadrant of the cartesian plane.
This can cause visible issues since the interactive boxes are designed to work with a resonably contained signal.
\\
...
I have chosen the template \texttt{tm-526-vanilla} from \href{https://templatemo.com}{templatemo.com} for my websute. \\
...
\begin{center}
    \begin{tabular}{ |l|p{9cm}| }
        ...
        \hline
        \textbf{Description} & ss \\
        \hline
        \textbf{Expected result} & sda \\
        \hline
    \end{tabular}
\end{center}
\egroup{}
...
\begin{center}
    \begin{tabular}{ |l|l|l| }
        \hline
        \textbf{Test-00} & \color{red} Failed & Note \\
        \hline
        \textbf{Test-01} & \color{blue} Successful & Note \\
        \hline
    \end{tabular}
\end{center}
\egroup{}
...
da citare:
A Course in Quantum Computing Community College Volume 1
