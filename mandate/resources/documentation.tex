...
\begin{center}
    \begin{tabular}{ |l|p{9cm}| }
        ...
        \hline
        \textbf{Req-03\_5} & The interactive box must contain a slider for the animation speed. \\
        \hline
    \end{tabular}
\end{center}
\egroup{}
...
\begin{center}
    \begin{tabular}{ |l|p{9cm}| }
        ...
        \hline
        \textbf{Req-04\_1} & All the interactive boxes can contain optional settings. \\
        \hline
    \end{tabular}
\end{center}
\egroup{}
